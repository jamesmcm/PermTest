...
shinyServer(function(input, output, clientData, session) {
  ...
  dnames <- reactive({
    ...
    if (names(data)==c("group", "value") | names(data)==c("value", "group")){
  ...
  rawdata <- reactive({
    ...
    names(choices)=c(paste0(names(data)[1]," and ", names(data)[2], " do not have the same mean"), paste0(names(data)[2], " has a greater mean than ", names(data)[1]), paste0(names(data)[2], " has a lower mean than ", names(data)[1]))
  ...
  filedata <- reactive({
    ...
    x1=data[!is.na(data[,names(data)[1]]),names(data)[1]]
    x2=data[!is.na(data[,names(data)[2]]),names(data)[2]]
  ...
  output$outtext <- renderText({
    ...
    if (pvalue<0.01){
      ...
      if (ah!="twosided"){
        ...
        result=paste0( "The mean of the sample distribution of ",names(rawdata())[2]," appears to be <b>significantly ", ah, "</b> than the mean of the sample distribution of ", names(rawdata())[1],".")
      }
      else{
        sigtest=paste0("The p-value, ", format(as.numeric(pvalue), nsmall=2, digits=3),",  is less than 0.01 (a 1% chance) and so the result is <b>statistically significant</b> at the <font color='red'><b>99%</b></font> significance level.")
        result=paste0("The mean of the sample distribution of ",names(rawdata())[2]," appears to be <b>significantly different</b> to the mean of the sample distribution of ", names(rawdata())[1]," at the <font color='red'><b>99%</b></font> significance level.")
      ...
      if (ah!="twosided"){
        ...
        sigtest=paste0("The p-value, ", format(as.numeric(pvalue), nsmall=2, digits=3),",  is less than 0.05 (a 5% chance) and so the result is <b>statistically significant</b> at the <font color='orange'><b>95%</b></font> significance level.")
        result=paste0("The mean of the sample distribution of ",names(rawdata())[2]," appears to be <b>significantly different</b> to the mean of the sample distribution of ", names(rawdata())[1]," at the <font color='orange'><b>95%</b></font> significance level.")
      ...
      if (ah!="twosided"){
        ...
        result=paste0( "The mean of the sample distribution of ",names(rawdata())[2]," appears to be <b>significantly ", ah, "</b> than the mean of the sample distribution of ", names(rawdata())[1]," at the <font color='yellow'><b>90%</b></font> significance level.")
      }
      else{
        sigtest=paste0("The p-value, ", format(as.numeric(pvalue), nsmall=2, digits=3),",  is less than 0.1 (a 10% chance) and so the result is <b>statistically significant</b> at the <font color='yellow'><b>90%</b></font> significance level.")
        result=paste0("The mean of the sample distribution of ",names(rawdata())[2]," appears to be <b>significantly different</b> to the mean of the sample distribution of ", names(rawdata())[1]," at the <font color='yellow'><b>90%</b></font> significance level.")
      ...
      if (ah!="twosided"){
        ...
        sigtest=paste0("The p-value, ", format(as.numeric(pvalue), nsmall=2, digits=3),",  is less than 0.2 (a 20% chance) and so the result is <b>statistically significant</b> at the <font color='green'><b>80%</b></font> significance level.")
        result=paste0("The mean of the sample distribution of ",names(rawdata())[2]," appears to be <b>significantly different</b> to the mean of the sample distribution of ", names(rawdata())[1]," at the <font color='green'><b>80%</b></font> significance level.")
      ...
      if (ah!="twosided"){
        ...
        result=paste0( "The mean of the sample distribution of ",names(rawdata())[2]," does <b>not</b> appear to be ", ah, " than the mean of the sample distribution of ", names(rawdata())[1],".")
        
      }
      else {
        sigtest=paste0("The p-value, ", format(as.numeric(pvalue), nsmall=2, digits=3),",  is greater than 0.05 (a 5% chance) and so the result is <b>not</b> statistically significant at the 95% significance level.")
        result=paste0( "The means of the underlying sample distributions of ",names(rawdata())[1]," and ",names(rawdata())[2]," appear to be <b>the same</b>.")
      }
